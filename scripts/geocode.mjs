...
const LOCATIONS = {
  ...
  'Gaston Bathalon': 'Troy, Vermont',
  'Laura Sirot': 'Wooster, Ohio',
  'Whitney Echenique': 'Dalton, Georgia',
  'Matthew Townsend': 'Fairfield, Maine',
  "Thomas O'Donnell": 'Keosauqua, Iowa',
  'Zeppelin Zeerip': 'Oakley, Utah',
  'Jamie Collins': 'Bend, Oregon',
  'Barbara Gooby': 'Savannah, Georgia',
  'Diana Spangler': 'Dallas, Georgia',
  'Will Rivera': 'Oneonta, New York',
  'Kenneth Matthews': 'Hurricane, West Virginia',
  'Marta Beck': 'Summit Point, West Virginia',
  'Randall Putz': 'Big Bear Lake, California',
  'Bennie Taylor': 'Cookeville, Tennessee',
  'Dusty Jones': 'Kingston, Oklahoma',
  'Nathan Brewer': 'Henryetta, Oklahoma',
  'Daniel Horoshak': 'Eveleth, Minnesota',
  'David Trumble': 'Weare, New Hampshire',
  'La Rhonda Odom': 'Kosciusko, Mississippi',
  'Siobhan McIntyre': 'Winfield, Kansas',
  'John Bartlett': 'Hartford City, Indiana',
  'Marc Bourassa': 'Bristol, New Hampshire',
  'Jarvus Turnley': 'Springfield, Tennessee',
}
