...
- [ ] Define a consistent popup template (bold name, office level, district #, town, state)
- [ ] Ensure all candidate data includes town and state fields
- [ ] Update popup rendering to use the standardized layout
